...
const file_api_auth_proto_rawDesc = "" +
	"\n" +
	"\x0eapi/auth.proto\x123github.com.PechatnovVladimir.gateway_gprs_test.auth\"@\n" +
	"\fLoginRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"(\n" +
	"\rLoginResponse\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userId2\xa0\x01\n" +
	"\vAuthService\x12\x90\x01\n" +
	"\x05Login\x12A.github.com.PechatnovVladimir.gateway_gprs_test.auth.LoginRequest\x1aB.github.com.PechatnovVladimir.gateway_gprs_test.auth.LoginResponse\"\x00B>Z<github.com/PechatnovVladimir/gateway_gprs_test/auth/api;authb\x06proto3"
...
var file_api_auth_proto_goTypes = []any{
	(*LoginRequest)(nil),  // 0: github.com.PechatnovVladimir.gateway_gprs_test.auth.LoginRequest
	(*LoginResponse)(nil), // 1: github.com.PechatnovVladimir.gateway_gprs_test.auth.LoginResponse
}
var file_api_auth_proto_depIdxs = []int32{
	0, // 0: github.com.PechatnovVladimir.gateway_gprs_test.auth.AuthService.Login:input_type -> github.com.PechatnovVladimir.gateway_gprs_test.auth.LoginRequest
	1, // 1: github.com.PechatnovVladimir.gateway_gprs_test.auth.AuthService.Login:output_type -> github.com.PechatnovVladimir.gateway_gprs_test.auth.LoginResponse
